...
<section class="section">
    <div class="container">
        ...
        <div class="section-header">
            ...
            <p class="section-desc">A glimpse into the vibrant life, events, and activities at the CST Department.</p>
        </div>
        ...
        <?php else: ?>
            ...
            <div class="empty-state" style="margin-top: -10px;">
                ...
                <p>Photos from our events and campus life will be added here soon. Stay tuned!</p>
            </div>
