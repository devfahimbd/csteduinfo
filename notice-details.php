<?php
/**
 * CST Department Website - Notice Detail Page
...
if (empty($slug)) {
    header('Location: ' . SITE_URL . '/notice.php');
    exit;
}
...
$notice = null;
try {
    $stmt = $pdo->prepare("SELECT n.*, c.name AS category_name FROM notices n LEFT JOIN categories c ON n.category_id = c.id WHERE n.slug = ? AND n.status = 1");
    $stmt->execute([$slug]);
    $notice = $stmt->fetch();
} catch (Exception $e) {
...
// ─── Page Title ───
$pageTitle = ($notice ? clean($notice['title']) . ' - ' : 'Notice - ') . SITE_NAME;
...
<head>
    ...
    <style>
        ...
        .meta-badge.academic    { background: #DBEAFE; color: #2563EB; }
        .meta-badge.event       { background: #F3E8FF; color: #7C3AED; }
        .meta-badge.exam        { background: #FFF7ED; color: #EA580C; }
        .meta-badge.important   { background: #FEE2E2; color: #DC2626; }
        .meta-badge.general     { background: #F1F5F9; color: #64748B; }
        .meta-badge.default-cat { background: #DBEAFE; color: #2563EB; }
    ...
    <div class="nav-container">
        <div class="nav-wrapper">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo SITE_URL; ?>/notice.php" class="active"><svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg><span>Notices</span></a></li>
                <li class="nav-more">
...
<section class="page-banner">
    <div class="container">
        <h1><?php echo clean($notice['title']); ?></h1>
        <div class="breadcrumb">
            ...
            <a href="<?php echo SITE_URL; ?>/notice.php">Notices</a>
            <span class="separator">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
            </span>
            <span><?php echo clean($notice['title']); ?></span>
        </div>
    </div>
</section>
<?php endif; ?>
    ...
    <div class="container">
        <div class="detail-content">
            ...
            <div class="detail-meta">
                <?php if ($catName): ?>
                    <span class="meta-badge <?php
                        $badgeClass = 'default-cat';
                        $catLower = strtolower($catName);
                        if (strpos($catLower, 'important') !== false || strpos($catLower, 'urgent') !== false) $badgeClass = 'important';
                        elseif (strpos($catLower, 'academic') !== false) $badgeClass = 'academic';
                        elseif (strpos($catLower, 'event') !== false) $badgeClass = 'event';
                        elseif (strpos($catLower, 'exam') !== false) $badgeClass = 'exam';
                        elseif (strpos($catLower, 'general') !== false) $badgeClass = 'general';
                        echo $badgeClass;
                    ?>">
            ...
            <div class="detail-body">
                <?php echo nl2br(clean($notice['content'])); ?>
            </div>
        ...
        <div class="back-link-wrapper" style="margin-top:32px;">
            <a href="<?php echo SITE_URL; ?>/notice.php" class="back-link">
...
<section class="not-found-section">
    ...
    <p>The notice you are looking for does not exist or has been removed.</p>
    <a href="<?php echo SITE_URL; ?>/notice.php" class="btn btn-outline">
