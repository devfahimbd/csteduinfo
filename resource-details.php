<?php
/**
 * CST Department Website - Resource Detail Page
...
if (empty($slug)) {
    header('Location: ' . SITE_URL . '/resources.php');
    exit;
}
...
$resource = null;
try {
    $stmt = $pdo->prepare("SELECT r.*, c.name AS category_name FROM resources r LEFT JOIN categories c ON r.category_id = c.id WHERE r.slug = ? AND r.status = 1");
    $stmt->execute([$slug]);
    $resource = $stmt->fetch();
} catch (Exception $e) {
    error_log("Resource fetch error: " . $e->getMessage());
    $resource = null;
}

// ─── Page Title ───
$pageTitle = ($resource ? clean($resource['title']) . ' - ' : 'রিসোর্স - ') . SITE_NAME;
...
$catName = '';
if ($resource) {
    $catName = !empty($resource['category_name']) ? $resource['category_name'] : getCategoryName($pdo, $resource['category_id']);
    $hasFile = !empty($resource['file_path']);
    $hasUrl  = !empty($resource['external_url']);
}
?>
<!DOCTYPE html>
<html lang="bn">
<head>
    ...
    <style>
        ...
        .resource-detail-meta .meta-category {
            background: #DBEAFE;
            color: #2563EB;
            padding: 4px 12px;
            border-radius: 20px;
        ...
        <div class="nav-wrapper">
            ...
            <ul class="nav-links">
                ...
                <li class="nav-more">
                    ...
                    <a href="<?php echo SITE_URL; ?>/resources.php" class="active"><svg class="dropdown-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg><span>রিসোর্স</span></a>
...
<section class="page-banner">
    <div class="container">
        <h1><?php echo clean($resource['title']); ?></h1>
        <div class="breadcrumb">
            ...
            <a href="<?php echo SITE_URL; ?>/resources.php">রিসোর্স</a>
            <span class="separator">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
            </span>
            <span><?php echo clean($resource['title']); ?></span>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="detail-page">
    <div class="container">
        <div class="resource-detail-content">
            ...
            <div class="resource-detail-meta">
                ...
                <span>
                    ...
                    <?php echo date('d M, Y', strtotime($resource['created_at'])); ?>
                </span>
                <span>
            ...
            <?php if (!empty($resource['description'])): ?>
                <div class="resource-detail-description">
                    <?php echo nl2br(clean($resource['description'])); ?>
                </div>
            <?php endif; ?>
            ...
            <div class="resource-actions">
                <?php if ($hasFile): ?>
                    <a href="<?php echo SITE_URL; ?>/download.php?type=resource&id=<?php echo (int) $resource['id']; ?>" class="btn btn-primary">
                ...
                <?php if ($hasUrl): ?>
                    <a href="<?php echo clean($resource['external_url']); ?>" target="_blank" rel="noopener" class="btn btn-outline">
        ...
        <div class="back-link-wrapper" style="margin-top:32px;">
            <a href="<?php echo SITE_URL; ?>/resources.php" class="back-link">
...
<section class="not-found-section">
    ...
    <h2>রিসোর্স খুঁজে পাওয়া যায়নি</h2>
    <p>আপনি যে রিসোর্সটি খুঁজছেন সেটি বিদ্যমান নেই বা সরানো হয়েছে।</p>
    <a href="<?php echo SITE_URL; ?>/resources.php" class="btn btn-outline">
