...
// ─── Page Title ───
$pageTitle = ($teacher ? clean($teacher['name']) . ' - ' : 'Faculty - ') . SITE_NAME;
    ...
    <div class="nav-container">
        <div class="nav-wrapper">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo SITE_URL; ?>/faculty.php" class="active">Faculty</a></li>
...
<section class="page-banner">
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <a href="<?php echo SITE_URL; ?>/faculty.php">Faculty</a>
            <span class="separator">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
            </span>
...
<section class="not-found-section">
    ...
    <p>The faculty member you are looking for does not exist or has been removed.</p>
