...
try {
    $stmt = $pdo->query("SELECT r.*, c.name AS category_name FROM resources r LEFT JOIN categories c ON r.category_id = c.id ORDER BY r.created_at DESC");
...
<head>
    ...
    <title>Resources - Admin Panel</title>
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge-note { background: #dbeafe; color: #2563eb; }
        .badge-assignment { background: #fef3c7; color: #d97706; }
        .badge-question { background: #fce7f3; color: #db2777; }
        .badge-syllabus { background: #f3e8ff; color: #7c3aed; }
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <header class="admin-header">
            <div class="breadcrumb"><a href="../dashboard.php">Dashboard</a> &nbsp;/&nbsp; <strong>Resources</strong></div>
        ...
        <div class="admin-body">
            ...
            <div class="toolbar">
                <div style="font-size:14px;font-weight:600;color:#111827;">All Resources</div>
                <a href="create.php" class="btn-primary"><?php echo icon('plus', 16); ?> Add Resource</a>
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-<?php echo $res['type']; ?>"><?php echo ucfirst($res['type']); ?></span></td>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href="delete.php?id=<?php echo $res['id']; ?>" class="btn-sm btn-delete" onclick="return confirm('Delete this resource?')">Delete</a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
