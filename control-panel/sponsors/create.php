...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            setFlash('error', 'Failed to create sponsor.');
        }
    }
}
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <header class="admin-header">
            <div class="breadcrumb"><a href="../dashboard.php">Dashboard</a> &nbsp;/&nbsp; <a href="index.php">Sponsors</a> &nbsp;/&nbsp; <strong>Add Sponsor</strong></div>
        ...
        <div class="admin-body">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="panel">
                    <div class="panel-header"><h2>Sponsor Details</h2></div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label>Name *</label>
                            <input type="text" name="name" required placeholder="Sponsor name">
                        </div>
                        <div class="form-group">
                            <label>Logo</label>
                            <input type="file" name="logo" accept="image/*">
                            <p class="hint">JPG, PNG, WebP, GIF, SVG</p>
                        </div>
                        <div class="form-group">
                ...
                <div style="display:flex;gap:10px;margin-top:4px;">
                    <button type="submit" class="btn-primary">Create Sponsor</button>
