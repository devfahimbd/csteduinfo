...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            $slug = generateSlug($name, 'teachers', 'slug');
            ...
            setFlash('error', 'Failed to add faculty member.');
        }
    }
}
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <header class="admin-header">
            <div class="breadcrumb"><a href="../dashboard.php">Dashboard</a> &nbsp;/&nbsp; <a href="index.php">Faculty</a> &nbsp;/&nbsp; <strong>Add Faculty</strong></div>
        ...
        <div class="admin-body">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="designation" required placeholder="e.g. Professor, Lecturer">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label>Qualification</label>
                                <input type="text" name="qualification" placeholder="e.g. PhD, MSc">
                            </div>
                            <div class="form-group">
                                <label>Photo</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="bio" rows="4" placeholder="Brief bio of the faculty member"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="serial" value="0" min="0">
                                <p class="hint">Used for sorting. Lower numbers appear first.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex;gap:10px;margin-top:4px;">
                    <button type="submit" class="btn-primary">Add Faculty Member</button>
