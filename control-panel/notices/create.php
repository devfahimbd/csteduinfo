...
<head>
    ...
    <title>Add Notice - Admin Panel</title>
    <style>
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <header class="admin-header">
            <div class="breadcrumb"><a href="../dashboard.php">Dashboard</a> &nbsp;/&nbsp; <a href="index.php">Notices</a> &nbsp;/&nbsp; <strong>Add Notice</strong></div>
        ...
        <div class="admin-body">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div style="display:flex;gap:10px;margin-top:4px;">
                    <button type="submit" class="btn-primary">Create Notice</button>
